    ...
    match op.flattened::<EntryTypes, LinkTypes>()? {
        ...
        FlatOp::RegisterCreateLink {
            ...
            match link_type {
                ...
                LinkTypes::CuratorToTools => {
                    validate_create_link_curator_to_tools(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::ToolToCurators => {
                    validate_create_link_tool_to_curators(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::AllCurators => {
                    validate_create_link_all_curators(
                        action,
                        base_address,
                        target_address,
                        tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            match link_type {
                ...
                LinkTypes::CuratorToTools => {
                    validate_delete_link_curator_to_tools(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::ToolToCurators => {
                    validate_delete_link_tool_to_curators(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::AllCurators => {
                    validate_delete_link_all_curators(
                        action,
                        original_action,
                        base_address,
                        target_address,
