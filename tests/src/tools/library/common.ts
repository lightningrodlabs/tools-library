...
export async function sampleDeveloperCollective(
  cell: CallableCell,
...
export async function createDeveloperCollective(
  cell: CallableCell,
  developerCollective = undefined
): Promise<Record> {
  return cell.callZome({
    zome_name: "library",
...
export async function sampleContributorPermission(
  cell: CallableCell,
  partialContributorPermission = {}
) {
  return {
    ...{
      for_collective: (await createDeveloperCollective(cell)).signed_action
        .hashed.hash,
...
export async function createContributorPermission(
  cell: CallableCell,
  contributorPermission = undefined
): Promise<Record> {
  return cell.callZome({
    zome_name: "library",
...
export async function sampleTool(cell: CallableCell, partialTool = {}) {
  return {
    ...{
      developer_collective: (await createDeveloperCollective(cell))
